setwd("E:/Dropbox (UiO)/Validation/0Code/PAM50/Her2/Analysis") 
...
Data1<-read.csv(".../PAM50/Her2/DiscoveryData.csv")
Data2<-read.csv(".../PAM50/Her2/ValidationData")

Shap1<-read.csv(".../PAM50/Her2/DiscoverySHAP.csv")
Shap2<-read.csv(".../PAM50/Her2/ValidationSHAP.csv")
...
pdf("E:/Dropbox (UiO)/Validation/0Code/PAM50/Her2/Analysis/Fig4d2.pdf",width=16,height=10)
ggplot(fit)+
...
fitHer2<-cbind( "Her2", fitHer2)
colnames(fitHer2) <- c("PAM50","Cell Type","Slope","LI", "HI", "Sign", "`Association Score`")
