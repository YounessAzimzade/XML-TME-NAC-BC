setwd("E:/Dropbox (UiO)/Validation/0Code/PAM50/LumB/Analysis") 
...
Data1<-read.csv(".../PAM50/LumB/DiscoveryData.csv")
Data2<-read.csv(".../PAM50/LumB/ValidationData")

Shap1<-read.csv(".../PAM50/LumB/DiscoverySHAP.csv")
Shap2<-read.csv(".../PAM50/LumB/ValidationSHAP.csv")
...
pdf("E:/Dropbox (UiO)/Validation/0Code/PAM50/LumB/Analysis/Fig4b.pdf",width=16,height=10)
ggplot(fit)+
...
fitLumB<-cbind( "LumB", fitLumB)
colnames(fitLumB) <- c("PAM50","Cell Type","Slope","LI", "HI", "Sign", "`Association Score`")
