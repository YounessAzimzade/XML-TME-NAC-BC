...
Data1<-read.csv(".../PAM50/LumA/DiscoveryData.csv")
Data2<-read.csv(".../PAM50/LumA/ValidationData")

Shap1<-read.csv(".../PAM50/LumA/DiscoverySHAP.csv")
Shap2<-read.csv(".../PAM50/LumA/ValidationSHAP.csv")
...
pdf(".../PAM50/LumA/Analysis/Fig4a.pdf",width=16,height=10)
ggplot(fit)+
...
fitLumA<-cbind( "LumA", fitLumA)
colnames(fitLumA) <- c("PAM50","Cell Type","Slope","LI", "HI", "Sign", "`Association Score`")
